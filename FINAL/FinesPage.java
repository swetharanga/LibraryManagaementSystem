...
public class FinesPage extends JFrame
{
	JFrame mainFrame;
	JPanel controlPanel;
	...
	void prepareGUI()
	{
		...
		controlPanel.add(header, gbc_header);		
                ...
                JLabel textLabel = new JLabel("Enter Borrower Card Number",JLabel.LEFT);
		...
		gbc_lblcard.insets=new Insets(0,0,15,0);
		gbc_lblcard.gridx=0;
		gbc_lblcard.gridy=3;
		...
		gbc_cardText.insets=new Insets(0,0,15,0);
		...
		gbc_finesDue.gridx = 1;
		gbc_finesDue.gridy = 4;
		//gbc_finesDue.gridwidth=2;
		controlPanel.add(finesDue,gbc_finesDue);
		
		//Paid Fines
		JButton fineHistory=new JButton("Book Payment History");
		fineHistory.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
				try {
					new FineHistory(cardText.getText());
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		gbc_paidFines.gridx = 0;
		gbc_paidFines.gridy = 4;
		//gbc_paidFines.gridwidth=2;
		controlPanel.add(fineHistory,gbc_paidFines);
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				try {
					...
					if(rs1.next())
					{
						...
						JOptionPane.showMessageDialog(null, "Total Outstanding Fines: " + fine.toString());
					}
					else
					{
						JOptionPane.showMessageDialog(null, "No outstanding fines at the moment.");
					}
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
